...
@interface B8_controller ()<UIActionSheetDelegate, UIAlertViewDelegate>
{
    BOOL         isMatch;
    ...
    UIAlertView *Name,*Auther,*Clean,*Relogin,*Version;
...
-(void)Adapter{
    ...
    if (width==320 && height==480) {
        ...
        self.P_filter.frame=CGRectMake(194,18,84,24);
        self.P_b1.frame=CGRectMake(61,78,43,65);
        self.P_b2.frame=CGRectMake(110,78,43,65);
        self.P_b3.frame=CGRectMake(160,78,43,65);
        self.P_pm.frame=CGRectMake(206,78,60,20);
        self.P_ug.frame=CGRectMake(206,118,59,25);
        self.P_f1.frame=CGRectMake(61,144,43,43);
        self.P_f2.frame=CGRectMake(110,144,43,43);
        self.P_f3.frame=CGRectMake(160,144,43,43);
        ...
        self.P_fun5.frame=CGRectMake(110,18,26,14);
        self.P_fun4.frame=CGRectMake(116,40,14,14);
        self.P_fun3.frame=CGRectMake(116,63,14,14);
        self.P_fun2.frame=CGRectMake(116,85,14,14);
        self.P_fun1.frame=CGRectMake(116,107,14,14);
        ...
        self.B_light.frame=CGRectMake(268,128,40,40);
        //view4
    ...
    if (width==320 && height==568) {
        ...
        self.P_filter.frame=CGRectMake(199,45,84,24);
        self.P_b1.frame=CGRectMake(59,123,43,65);
        self.P_b2.frame=CGRectMake(109,123,43,65);
        self.P_b3.frame=CGRectMake(160,123,43,65);
        self.P_pm.frame=CGRectMake(211,123,60,20);
        self.P_ug.frame=CGRectMake(211,163,59,25);
        self.P_f1.frame=CGRectMake(59,190,43,43);
        self.P_f2.frame=CGRectMake(109,190,43,43);
        self.P_f3.frame=CGRectMake(160,190,43,43);
...
- (NSData*)hexToData:(NSString *)hexString {
    ...
    B8hexToBytes(bytes, [hexString UTF8String], (int)[hexString length]);
...
void B8hexToBytes(char * bytes, const char * hexString, int hexLength)
{
    ...
    if (payload != nil){
        ...
        if ([output hasPrefix:@"4"]) {
            ...
            if ([hh intValue]==1 ) {
                ...
                switch ([ss intValue]) {
                    case 0:
                        [self.P_fun1 setImage:[UIImage imageNamed:@"b8_fun1_off.png"]];
                        [self.P_fun2 setImage:[UIImage imageNamed:@"b8_fun2_off.png"]];
                        [self.P_fun3 setImage:[UIImage imageNamed:@"b8_fun3_off.png"]];
                        [self.P_fun4 setImage:[UIImage imageNamed:@"b8_fun4_off.png"]];
                        [self.P_fun5 setImage:[UIImage imageNamed:@"b8_fun5_off.png"]];
                        roll2=1;
                        break;
                    case 1:
                        [self.P_fun1 setImage:[UIImage imageNamed:@"b8_fun1_on.png"]];
                        [self.P_fun2 setImage:[UIImage imageNamed:@"b8_fun2_off.png"]];
                        [self.P_fun3 setImage:[UIImage imageNamed:@"b8_fun3_off.png"]];
                        [self.P_fun4 setImage:[UIImage imageNamed:@"b8_fun4_off.png"]];
                        [self.P_fun5 setImage:[UIImage imageNamed:@"b8_fun5_off.png"]];
                    ...
                    case 2:
                        [self.P_fun1 setImage:[UIImage imageNamed:@"b8_fun1_off.png"]];
                        [self.P_fun2 setImage:[UIImage imageNamed:@"b8_fun2_on.png"]];
                        [self.P_fun3 setImage:[UIImage imageNamed:@"b8_fun3_off.png"]];
                        [self.P_fun4 setImage:[UIImage imageNamed:@"b8_fun4_off.png"]];
                        [self.P_fun5 setImage:[UIImage imageNamed:@"b8_fun5_off.png"]];
                        roll2=3;
                    ...
                    case 3:
                        [self.P_fun1 setImage:[UIImage imageNamed:@"b8_fun1_off.png"]];
                        [self.P_fun2 setImage:[UIImage imageNamed:@"b8_fun2_off.png"]];
                        [self.P_fun3 setImage:[UIImage imageNamed:@"b8_fun3_on.png"]];
                        [self.P_fun4 setImage:[UIImage imageNamed:@"b8_fun4_off.png"]];
                        [self.P_fun5 setImage:[UIImage imageNamed:@"b8_fun5_off.png"]];
                        roll2=4;
                        break;
                    case 4:
                        ...
                        [self.P_fun2 setImage:[UIImage imageNamed:@"b8_fun2_off.png"]];
                        [self.P_fun3 setImage:[UIImage imageNamed:@"b8_fun3_off.png"]];
                        [self.P_fun4 setImage:[UIImage imageNamed:@"b8_fun4_on.png"]];
                        [self.P_fun5 setImage:[UIImage imageNamed:@"b8_fun5_off.png"]];
                        roll2=5;
                        break;
                    case 5:
                        ...
                        [self.P_fun3 setImage:[UIImage imageNamed:@"b8_fun3_off.png"]];
                        [self.P_fun4 setImage:[UIImage imageNamed:@"b8_fun4_off.png"]];
                        [self.P_fun5 setImage:[UIImage imageNamed:@"b8_fun5_on.png"]];
                        roll2=1;
                        break;
                    default:
                        [self.P_fun1 setImage:[UIImage imageNamed:@"b8_fun1_on.png"]];
        ...
        if ([output hasPrefix:@"7"]) {
            ...
            if([open isEqualToString:@"1"])
            {
                ...
                switch ([pm1 intValue]) {
                    case 0:
                        [self.P_b1 setImage:[UIImage imageNamed:@"b8_b0.png"]];
                        [self.P_f1 setImage:[UIImage imageNamed:@"b8_reflect_0.png"]];
                        break;
                    case 1:
                        [self.P_b1 setImage:[UIImage imageNamed:@"b8_b1.png"]];
                        [self.P_f1 setImage:[UIImage imageNamed:@"b8_reflect_1.png"]];
                        break;
                    case 2:
                        [self.P_b1 setImage:[UIImage imageNamed:@"b8_b2.png"]];
                        [self.P_f1 setImage:[UIImage imageNamed:@"b8_reflect_2.png"]];
                        break;
                    case 3:
                        [self.P_b1 setImage:[UIImage imageNamed:@"b8_b3.png"]];
                        [self.P_f1 setImage:[UIImage imageNamed:@"b8_reflect_3.png"]];
                        break;
                    case 4:
                        [self.P_b1 setImage:[UIImage imageNamed:@"b8_b4.png"]];
                        [self.P_f1 setImage:[UIImage imageNamed:@"b8_reflect_4.png"]];
                        break;
                    case 5:
                        [self.P_b1 setImage:[UIImage imageNamed:@"b8_b5.png"]];
                        [self.P_f1 setImage:[UIImage imageNamed:@"b8_reflect_5.png"]];
                        break;
                    case 6:
                        [self.P_b1 setImage:[UIImage imageNamed:@"b8_b6.png"]];
                        [self.P_f1 setImage:[UIImage imageNamed:@"b8_reflect_6.png"]];
                        break;
                    case 7:
                        [self.P_b1 setImage:[UIImage imageNamed:@"b8_b7.png"]];
                        [self.P_f1 setImage:[UIImage imageNamed:@"b8_reflect_7.png"]];
                        break;
                    case 8:
                        [self.P_b1 setImage:[UIImage imageNamed:@"b8_b8.png"]];
                        [self.P_f1 setImage:[UIImage imageNamed:@"b8_reflect_8.png"]];
                        break;
                    case 9:
                        [self.P_b1 setImage:[UIImage imageNamed:@"b8_b9.png"]];
                        [self.P_f1 setImage:[UIImage imageNamed:@"b8_reflect_9.png"]];
                        break;
                    default:
                        [self.P_b1 setImage:[UIImage imageNamed:@"b8_b0.png"]];
                        [self.P_f1 setImage:[UIImage imageNamed:@"b8_reflect_0.png"]];
                ...
                switch ([pm2 intValue]) {
                    case 0:
                        [self.P_b2 setImage:[UIImage imageNamed:@"b8_b0.png"]];
                        [self.P_f2 setImage:[UIImage imageNamed:@"b8_reflect_0.png"]];
                        break;
                    case 1:
                        [self.P_b2 setImage:[UIImage imageNamed:@"b8_b1.png"]];
                        [self.P_f2 setImage:[UIImage imageNamed:@"b8_reflect_1.png"]];
                        break;
                    case 2:
                        [self.P_b2 setImage:[UIImage imageNamed:@"b8_b2.png"]];
                        [self.P_f2 setImage:[UIImage imageNamed:@"b8_reflect_2.png"]];
                        break;
                    case 3:
                        [self.P_b2 setImage:[UIImage imageNamed:@"b8_b3.png"]];
                        [self.P_f2 setImage:[UIImage imageNamed:@"b8_reflect_3.png"]];
                        break;
                    case 4:
                        [self.P_b2 setImage:[UIImage imageNamed:@"b8_b4.png"]];
                        [self.P_f2 setImage:[UIImage imageNamed:@"b8_reflect_4.png"]];
                        break;
                    case 5:
                        [self.P_b2 setImage:[UIImage imageNamed:@"b8_b5.png"]];
                        [self.P_f2 setImage:[UIImage imageNamed:@"b8_reflect_5.png"]];
                        break;
                    case 6:
                        [self.P_b2 setImage:[UIImage imageNamed:@"b8_b6.png"]];
                        [self.P_f2 setImage:[UIImage imageNamed:@"b8_reflect_6.png"]];
                        break;
                    case 7:
                        [self.P_b2 setImage:[UIImage imageNamed:@"b8_b7.png"]];
                        [self.P_f2 setImage:[UIImage imageNamed:@"b8_reflect_7.png"]];
                        break;
                    case 8:
                        [self.P_b2 setImage:[UIImage imageNamed:@"b8_b8.png"]];
                        [self.P_f2 setImage:[UIImage imageNamed:@"b8_reflect_8.png"]];
                        break;
                    case 9:
                        [self.P_b2 setImage:[UIImage imageNamed:@"b8_b9.png"]];
                        [self.P_f2 setImage:[UIImage imageNamed:@"b8_reflect_9.png"]];
                        break;
                    default:
                        [self.P_b2 setImage:[UIImage imageNamed:@"b8_b0.png"]];
                        [self.P_f2 setImage:[UIImage imageNamed:@"b8_reflect_0.png"]];
                ...
                switch ([pm3 intValue]) {
                    case 0:
                        [self.P_b3 setImage:[UIImage imageNamed:@"b8_b0.png"]];
                        [self.P_f3 setImage:[UIImage imageNamed:@"b8_reflect_0.png"]];
                        break;
                    case 1:
                        [self.P_b3 setImage:[UIImage imageNamed:@"b8_b1.png"]];
                        [self.P_f3 setImage:[UIImage imageNamed:@"b8_reflect_1.png"]];
                        break;
                    case 2:
                        [self.P_b3 setImage:[UIImage imageNamed:@"b8_b2.png"]];
                        [self.P_f3 setImage:[UIImage imageNamed:@"b8_reflect_2.png"]];
                        break;
                    case 3:
                        [self.P_b3 setImage:[UIImage imageNamed:@"b8_b3.png"]];
                        [self.P_f3 setImage:[UIImage imageNamed:@"b8_reflect_3.png"]];
                        break;
                    case 4:
                        [self.P_b3 setImage:[UIImage imageNamed:@"b8_b4.png"]];
                        [self.P_f3 setImage:[UIImage imageNamed:@"b8_reflect_4.png"]];
                        break;
                    case 5:
                        [self.P_b3 setImage:[UIImage imageNamed:@"b8_b5.png"]];
                        [self.P_f3 setImage:[UIImage imageNamed:@"b8_reflect_5.png"]];
                        break;
                    case 6:
                        [self.P_b3 setImage:[UIImage imageNamed:@"b8_b6.png"]];
                        [self.P_f3 setImage:[UIImage imageNamed:@"b8_reflect_6.png"]];
                        break;
                    case 7:
                        [self.P_b3 setImage:[UIImage imageNamed:@"b8_b7.png"]];
                        [self.P_f3 setImage:[UIImage imageNamed:@"b8_reflect_7.png"]];
                        break;
                    case 8:
                        [self.P_b3 setImage:[UIImage imageNamed:@"b8_b8.png"]];
                        [self.P_f3 setImage:[UIImage imageNamed:@"b8_reflect_8.png"]];
                        break;
                    case 9:
                        [self.P_b3 setImage:[UIImage imageNamed:@"b8_b9.png"]];
                        [self.P_f3 setImage:[UIImage imageNamed:@"b8_reflect_9.png"]];
                        break;
                    default:
                        [self.P_b3 setImage:[UIImage imageNamed:@"b8_b0.png"]];
                        [self.P_f3 setImage:[UIImage imageNamed:@"b8_reflect_0.png"]];
                ...
                if ([filter isEqualToString:@"00"]) {
                    [self.P_filter setImage:[UIImage imageNamed:@"b8_filter_change.png"]];
                }
                else
                {
                    if ([filter isEqualToString:@"100"]) {
                        [self.P_filter setImage:[UIImage imageNamed:@"b8_filter_100.png"]];
                    }
                    else
                    {
                        
                        NSString *nn=[filter substringWithRange:NSMakeRange(0, 1)];
                        switch ([nn integerValue]) {
                            case 0:
                                [self.P_filter setImage:[UIImage imageNamed:@"b8_filter_10.png"]];
                                break;
                            case 1:
                                [self.P_filter setImage:[UIImage imageNamed:@"b8_filter_20.png"]];
                                break;
                            case 2:
                                [self.P_filter setImage:[UIImage imageNamed:@"b8_filter_30.png"]];
                                break;
                            case 3:
                                [self.P_filter setImage:[UIImage imageNamed:@"b8_filter_40.png"]];
                                break;
                            case 4:
                                [self.P_filter setImage:[UIImage imageNamed:@"b8_filter_50.png"]];
                                break;
                            case 5:
                                [self.P_filter setImage:[UIImage imageNamed:@"b8_filter_60.png"]];
                                break;
                            case 6:
                               [self.P_filter setImage:[UIImage imageNamed:@"b8_filter_70.png"]];
                                break;
                            case 7:
                                [self.P_filter setImage:[UIImage imageNamed:@"b8_filter_80.png"]];
                                break;
                            case 8:
                                [self.P_filter setImage:[UIImage imageNamed:@"b8_filter_90.png"]];
                                break;
                            case 9:
                                [self.P_filter setImage:[UIImage imageNamed:@"b8_filter_100.png"]];
                                break;
