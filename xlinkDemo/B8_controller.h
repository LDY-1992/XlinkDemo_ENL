...
@interface B8_controller : UIViewController
...
@property (strong, nonatomic) IBOutlet UIImageView *P_f3;
@property (strong, nonatomic) IBOutlet UIImageView *P_f1;
@property (strong, nonatomic) IBOutlet UIImageView *P_f2;
...
@property (strong, nonatomic) IBOutlet UIImageView *P_fun5;
